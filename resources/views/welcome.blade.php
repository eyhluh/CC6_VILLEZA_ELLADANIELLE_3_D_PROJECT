  ...
  <div class="min-h-screen flex flex-col">
    ...
    <header class="bg-white dark:bg-gray-800 shadow-md">
      <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        <!-- Logo -->
        <div class="text-indigo-500 text-2xl font-semibold">Ella Danielle Villeza</div>
    ...
    <section id="home" class="flex-1 flex flex-col-reverse md:flex-row items-center justify-between px-6 sm:px-10 md:px-16 py-12 bg-white dark:bg-gray-800">
      <div class="md:w-1/2">
        <h1 class="text-3xl sm:text-4xl md:text-5xl font-semibold dark:text-white text-black mb-4">Hello, I’m Ella Danielle Villeza</h1>
    ...
    <section id="about" class="px-6 sm:px-10 md:px-16 py-12 bg-white dark:bg-gray-800">
      ...
      <p class="text-lg sm:text-xl font-medium  dark:text-white text-black ">
        Hi, my name is Ella Danielle Villeza, a Fullstack Web Developer, UI Designer, and Mobile Developer. I have honed my skills in Web Development and advanced UI design principles, enabling me to create intuitive and visually appealing applications.
      </p>
    </section>
